...
public class KsyunDeploymentOperationsImpl extends HasMetadataOperation<Deployment, DeploymentList, DoneableDeployment, ScalableResource<Deployment, DoneableDeployment>>
  implements ScalableResource<Deployment, DoneableDeployment> {

  static final transient Logger LOG = LoggerFactory.getLogger(KsyunDeploymentOperationsImpl.class);

  public KsyunDeploymentOperationsImpl(OkHttpClient client, Config config, String namespace) {
  ...
  public KsyunDeploymentOperationsImpl(OkHttpClient client, Config config, String apiVersion, String namespace, String name, Boolean cascading, Deployment item, String resourceVersion, Boolean reloadingFromServer, long gracePeriodSeconds, Map<String, String> labels, Map<String, String> labelsNot, Map<String, String[]> labelsIn, Map<String, String[]> labelsNotIn, Map<String, String> fields) {
  ...
  private static class DeploymentReaper implements Reaper {
    private KsyunDeploymentOperationsImpl oper;

    public DeploymentReaper(KsyunDeploymentOperationsImpl oper) {
      this.oper = oper;
    }
